...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
    header("location:http://localhost/mmt/login.php");
    exit;
}
...
<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="index.html" class="nav-item nav-link ">Home</a>
                ...
                <a href="order online.php" class="nav-item nav-link active">Order online</a>
	...
	<div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center py-5">
            <h1 class="display-3 text-white mb-4 animated slideInDown">Order online</h1>
...
<a href="http://localhost/mmt/index.php" class="btn btn-warning">List data</a>
